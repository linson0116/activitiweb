...
//        deleteProcessDefinition("30001");
    ...
    public Deployment deploymentProcessDefinition(String depName, String resName) {
        Deployment deployment = processEngine.getRepositoryService()//与流程定义和部署对象相关的Service
                ...
                .addClasspathResource("processes/" + resName + ".bpmn")//从classpath的资源中加载，一次只能加载一个文件
                .addClasspathResource("processes/" + resName + ".png")//从classpath的资源中加载，一次只能加载一个文件
                .deploy();//完成部署
